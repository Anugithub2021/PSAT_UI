...
os.chdir(r'C:\Users\Aman Jha\Documents\GitHub\PSAT_UI') # making the parent directory as current directory

def proj_psat_gui():
	# Find more emojis here: https://www.webfx.com/tools/emoji-cheat-sheet/
	st.set_page_config(page_title="CS384 Project 3", page_icon=":dizzy:",layout="wide") # basic page configuration
	
	with st.container():
		st.title("Project 3 of Python!!! :fire:")
		st.header("Made by Anuradha Das Group and Aman Jha :star2:")
		st.subheader("2001CB10 and 2001EE22")
		st.write('''
		This is a page where you have been asked for different inputs which will be used in psat_v3 program made by Mayank Agarwal Sir. :smile:''')
		st.write("---")
		
	with st.container():
		st.subheader("Give constant_fk2d:")
		global constant_fk2d
		constant_fk2d=st.text_input("Enter value of constant_fk2d",placeholder="Enter a floating value, for example:- 0.75")
		
		try:
			constant_fk2d=float(constant_fk2d)
		except Exception as e:
			st.write("Please enter a float value for constant_fk2d.")
		st.write("---")
			
	with st.container():
		st.subheader("Give multiplying_factor_3d:")
		global multiplying_factor_3d
		multiplying_factor_3d=st.text_input("Enter value of multiplying_factor_3d",placeholder="Enter a floating value, for example:- 0.5")
		
		try:
			multiplying_factor_3d=float(multiplying_factor_3d)
		except Exception as e:
			st.write("Please enter a float value for multiplying_factor_3d.")
		st.write("---")
	
	with st.container():
		st.subheader("Give Shear_velocity:")
		global Shear_velocity
		Shear_velocity=st.text_input("Enter value of Shear_velocity",placeholder="Enter a floating value, for example:- 0.5")
		
		try:
			Shear_velocity=float(Shear_velocity)
		except Exception as e:
			st.write("Please enter a float value for Shear_velocity.")
		st.write("---")
	
	with st.container():
		st.header("Chose Filtering Method!!!")
		st.subheader("The following options are:")
		...
		global tch
		tch=st.text_input("Chose Filtering Method From Above:",placeholder="Enter the filtering Method from 1 to 8 that you want.")
		
		try:
			tch=int(tch)
		except Exception as e:
			st.write("Please enter an integer value for tch.")
			print(e)
		st.write("---")
		
		st.subheader("Please fill only those details corresponding to your choice of filtering method")
		
		global corr
		corr=st.text_input("Enter thresold value C:",placeholder="Enter an integer value for corr.")
		
		try:
			corr=int(corr)
		except Exception as e:
			st.write("Please enter an integer value for corr.")
			print(e)
		st.write("---")
		
		global SNR
		SNR=st.text_input("Enter thresold value S:",placeholder="Enter an integer value for SNR.")
		
		try:
			SNR=int(SNR)
		except Exception as e:
			st.write("Please enter an integer value for SNR.")
			print(e)
		st.write("---")
		
		global Lambda
		Lambda=st.text_input("Enter Lambda value for A:",placeholder="Enter a float value for lambda")
		
		try:
			Lambda=float(Lambda)
		except Exception as e:
			st.write("Please enter a float value for Lambda.")
			print(e)
		st.write("---")
		
		global k
		k=st.text_input("Enter k value for A:",placeholder="Enter a float value for k")
		
		try:
			k=float(k)
		except Exception as e:
			st.write("Please enter a float value for k.")
			print(e)
		
		st.write("---")
		
	with st.container():
		st.header("For Replacement Method!!!")
		st.subheader("The following options are:")
		...
		global sch
		sch=st.text_input("Chose Replacement Method From Above:",placeholder="Enter the Replacement Method from 1 to 7 that you want.")
		
		try:
			sch=int(sch)
		except Exception as e:
			st.write("Please enter an integer value for sch.")
			print(e)
		
	st.title("Thank You Mayank Agarwal Sir for teaching this lovely course! We really learnt a lot by this amazing course:):heart:")
	# st.header
